...
public class StaffActivity extends ActionBarActivity {
    ...
    private static String updateReport= "http://plbpc013.ouhk.edu.hk/s1129900/FYP/updateReportStaff.php";
...
*/
    ...
    class Getemail extends AsyncTask<String, String, String>{
        ...
        public void sendemail(){
            ...
            try {
                ...
                Toast.makeText(StaffActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    class SaveProductDetailsSpam extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            Toast message = Toast.makeText(StaffActivity.this, "The report is a spam!", Toast.LENGTH_SHORT);
            message.show();
        }
    }
    ...
    class SaveProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            Toast message = Toast.makeText(StaffActivity.this, "This report is completed!", Toast.LENGTH_SHORT);
            message.show();
           // new Getemail().execute();
