...
public class ReportActivity extends ListActivity {
    ...
    private static String url_my_report = "http://plbpc013.ouhk.edu.hk/s1129900/FYP/getManReport.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0) {
                    url_my_report = "http://plbpc013.ouhk.edu.hk/s1129900/FYP/getManReport.php";
                    productsList.clear();
                    new LoadAllProducts().execute();
                    clickCallBack();
                ...
                if(position ==1){
                    url_my_report = "http://plbpc013.ouhk.edu.hk/s1129900/FYP/getManReportDesc.php";
                    productsList.clear();
                    new LoadAllProducts().execute();
                    clickCallBack();
                }
